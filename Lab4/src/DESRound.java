...
public class DESRound {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Do you want to input values manually or generate them randomly?");
        ...
        System.out.println("Expanded R(i-1) (length " + expandedRiMinus1.length() + "): " + expandedRiMinus1);

        // XOR with Key
        String xorResult = xorStrings(expandedRiMinus1, ki);
        System.out.println("XOR with K(i) (length " + xorResult.length() + "): " + xorResult);
    ...
    private static String generateRandomBinaryString(int length, Random random) {
